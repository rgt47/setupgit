...
IMAGES (4 total: hero + 3 ambiance, all in media/images/)
  [ ] Hero image (80% width)        — currently hero.png (old placeholder)
  [ ] Ambiance image 1 (after Objectives)     — currently ambiance1.png
  [ ] Ambiance image 2 (after core workflow)  — currently ambiance2.png
  [ ] Ambiance image 3 (before Lessons Learnt) — currently ambiance3.png
...
![Settling in for version control setup.](media/images/ambiance1.png){.img-fluid height=3.5in}
...
[ ] Visual design
    [ ] 1 hero image (width=80%, fig-align=center) — swap hero.png for
        the hero.jpg already present in media/images/
    [ ] 3 ambiance images (.img-fluid only) — swap ambiance1/2/3.png for
        the matching .jpg files already present in media/images/
    [ ] media/images/README.md attributes every image actually in use
